...
function Example4() {
    ...
    console.log(makePair("Jayant", "Sharma")); // see it's simple as fck
}
...
function Example6() {
    class Array {
        ...
        add(value) { this._contents.push(value); }
        get length() { return this._contents.length; }
        get contents() { return this._contents; }
    }
    // Now you can create the array of any Type
    const number_arr = new Array();
    number_arr.add(12);
    console.log(number_arr.length, number_arr.contents);
    const string_arr = new Array();
    string_arr.add("BKL");
...
// or inferred.
function Example12() {
    const response = { status: 200, data: "Success" }; // This works as T by default is string
    ...
    const response2 = { status: 124, data: 233 }; // Just add Type variable value in Response Type.
}
