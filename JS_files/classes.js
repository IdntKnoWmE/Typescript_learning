...
function Example2() {
    class Pornstar {
        constructor(name, salary, penis_size) {
            this.name = name;
            this.salary = salary;
...
function Example9() {
    class Truck {
        constructor(horsePower, numberOfStrokes, capacity) {
...
function Example10() {
    class PetrolCar {
        Mileage() { console.log("Typical petrol car average ranges typically fall between 15 to 25 kmpl "); }
    }
    class BatteryCar {
        Capacity() { console.log("Typical Battery car capacities ranges from 17 kWh to over 100 kWh"); }
    }
